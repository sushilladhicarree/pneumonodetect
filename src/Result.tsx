        ...
        {isProcessing ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {renderPatientInfo("Patient Name", patientData.name, <User className="w-6 h-6" />)}
              {renderPatientInfo("Patient ID", patientData.id, <User className="w-6 h-6" />)}
              {renderPatientInfo("Age", `${patientData.age} years`, <Clock className="w-6 h-6" />)}
              {renderPatientInfo("Contact", patientData.phone, <User className="w-6 h-6" />)}
            </div>

            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-lg shadow-sm p-4">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">X-ray Image</h3>
                ...
                <div className={`p-6 rounded-lg mb-6 ${
                  ...
                  <div className="text-center">
                    <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 ${
                      hasPneumonia ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"
                    }`}>
                      {hasPneumonia ? (
                    ...
                    <p className={hasPneumonia ? "text-red-600" : "text-green-600"}>
                      {hasPneumonia ? "Signs of pneumonia infection found" : "No signs of pneumonia detected"}
                    </p>
                  </div>
                </div>
                    ...
                    {historyData.map((entry, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="text-sm text-gray-500">ID: {entry.patient.id}</div>
                          <div className="text-sm text-gray-500">Age: {entry.patient.age}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-600">{entry.confidence}%</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
