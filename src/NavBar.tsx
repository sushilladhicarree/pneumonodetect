    ...
    <div id="root">
      <div className="container flex h-screen">
        ...
        <nav 
          id="sidebar" 
          ref={sidebarRef}
          className={`fixed w-64 h-full bg-blue-50 border-r border-blue-100 transition-all duration-300 transform ${
        ...
        >
          ...
          <div className="py-4">
            <a 
              ...
              onClick={() => handleNavLinkClick('dashboard_main')}
            >
              <span className="mr-3">
            ...
            <a 
              ...
              onClick={() => handleNavLinkClick('upload_section')}
            >
              <span className="mr-3">
            ...
            <a 
              ...
              onClick={() => handleNavLinkClick('analysis_results')}
            >
              <span className="mr-3">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
